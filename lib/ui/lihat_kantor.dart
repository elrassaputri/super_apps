...
class lihat_kantor extends StatefulWidget{
  @override
...
class pageLihatKantor extends State<lihat_kantor> {
  ...
  void _add(String id,String latitude,String longitude,String witel,String address,String radius) {
...
class dataLokasi{
  ...
  dataLokasi({this.alamat,this.latitude,this.longitude});
